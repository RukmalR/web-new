        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://i.pinimg.com/1200x/60/cd/fa/60cdfa8f57938d3cfdc8d0d4e61c335f.jpg"
                alt="JCB Excavator"
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://i.pinimg.com/1200x/a2/cb/26/a2cb2605be531e3879e8f6e6c18c5098.jpg"
                alt="Transport Lorry"
                className="w-full h-40 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://i.pinimg.com/1200x/c2/f2/7b/c2f27bc3deb44b1973a5a08550e29cec.jpg"
                alt="Water Bowser"
                className="w-full h-40 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <img
                src="https://i.pinimg.com/736x/02/a1/b9/02a1b9a7f8fdb6dbe7fccf0db702848d.jpg"
                alt="Boom Lift"
                className="w-full h-40 object-cover"
              />
              <div className="p-6">
